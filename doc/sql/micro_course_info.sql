-- drop index IDX_MICRO_COURSE_INFO_COURSE_ID on micro_course_info;
--
-- drop index IDX_MICRO_COURSE_INFO_GGS_TIME on micro_course_info;

drop table if exists micro_course_info;

/*==============================================================*/
/* Table: micro_course_info                                     */
/*==============================================================*/
...
alter table micro_course_info comment '微课程信息表';

/*==============================================================*/
/* Index: IDX_MICRO_COURSE_INFO_GGS_TIME                        */
/*==============================================================*/
create index IDX_MICRO_COURSE_INFO_GGS_TIME on micro_course_info
(
   ggs_time
);
...
/*==============================================================*/
create index IDX_MICRO_COURSE_INFO_COURSE_ID on micro_course_info
(
   course_id
);
