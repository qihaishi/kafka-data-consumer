...
alter table material_info_del comment '教材信息表';

/*==============================================================*/
/* Index: idx_material_id                                       */
/*==============================================================*/
create index idx_material_id on material_info_del
(
   id
);
...
/*==============================================================*/
create index idx_material_version_id on material_info_del
(
   type_id
);